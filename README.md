...
Replace YOUR_USERNAME with your actual GitHub username in all URLs below.
After pushing to GitHub, the images will render automatically.

### EDA Charts (auto-generated by running main.py)

<p align="center">
  <img src="https://raw.githubusercontent.com/YOUR_USERNAME/employee-performance-predictor/main/images/01_performance_distribution.png" width="48%" alt="Performance Distribution" />
  <img src="https://raw.githubusercontent.com/YOUR_USERNAME/employee-performance-predictor/main/images/02_dept_performance.png" width="48%" alt="Department Performance" />
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/YOUR_USERNAME/employee-performance-predictor/main/images/03_training_vs_performance.png" width="48%" alt="Training vs Performance" />
  <img src="https://raw.githubusercontent.com/YOUR_USERNAME/employee-performance-predictor/main/images/05_salary_boxplot.png" width="48%" alt="Salary by Performance" />
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/YOUR_USERNAME/employee-performance-predictor/main/images/04_correlation_heatmap.png" width="70%" alt="Correlation Heatmap" />
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/YOUR_USERNAME/employee-performance-predictor/main/images/06_satisfaction_violin.png" width="48%" alt="Satisfaction Score" />
  <img src="https://raw.githubusercontent.com/YOUR_USERNAME/employee-performance-predictor/main/images/07_feature_importance.png" width="48%" alt="Feature Importance" />
</p>

### Dashboard Screenshots (take these after running: streamlit run app.py)

To add dashboard screenshots:
1. Run the app: streamlit run app.py
2. Take screenshots of each page
3. Save them to the images/ folder with names like dashboard_analytics.png
4. Push to GitHub and add them below using the same URL pattern above

<!--
Uncomment and fill in after taking screenshots:

<p align="center">
  <img src="https://raw.githubusercontent.com/YOUR_USERNAME/employee-performance-predictor/main/images/dashboard_analytics.png" width="80%" alt="Analytics Dashboard" />
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/YOUR_USERNAME/employee-performance-predictor/main/images/dashboard_prediction.png" width="80%" alt="Single Prediction" />
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/YOUR_USERNAME/employee-performance-predictor/main/images/dashboard_confusion_matrix.png" width="80%" alt="Confusion Matrix" />
</p>
-->
...
A Pipeline guarantees that the same transformations applied during training are applied identically during inference. Manual preprocessing steps can easily fall out of sync between training and serving code.

**How is class imbalance handled?**
Using `class_weight='balanced'` in tree-based and linear models. This adjusts sample weights inversely proportional to class frequency without requiring oversampling or undersampling.

**How do you add a new feature?**
Add one line to `FeatureEngineer.transform()` in `src/pipeline.py`. The ColumnTransformer picks it up automatically because the new column lands in the numeric features list defined in `src/config.py`.

**How would you deploy this in production?**
The pipeline.pkl is loaded once at startup by the FastAPI app. Any request hits `/predict`, the raw JSON is converted to a DataFrame, `pipeline.predict()` is called, and the response is returned. The Docker image packages everything needed to run this in one command.

**What does the attrition risk score measure?**
It is a 0-10 composite score based on absenteeism days (positive direction), satisfaction score, training hours, and manager rating (all negative direction). An employee with zero absenteeism and maximum scores on all other metrics receives a score near 0. An employee with maximum absenteeism and minimum scores receives a score near 10.
